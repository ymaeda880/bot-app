...
#   [env]        : location = "Develop" | "Mac" | "Server"
#   [mounts]     : Mac="/Volumes/Extreme SSD", Server="/srv/ssd" など
#   [locations.*]: 環境ごとのルート（pdf_root / backup_root / data_root）
#   [app]        : available_presets=["Develop","Mac","Server"], bot_bucket="bot_data"（任意）
# - フォールバック:
#   available_presets = ("Develop","Mac","Server")
#   pdf_root    = <APP_ROOT>/pdf
#   backup_root = <APP_ROOT>/backup
#   data_root   = <APP_ROOT>/data
#   vs_root     = data_root/vectorstore  ← ★ 自動連動（ENV 上書きは削除）
# - 設定ファイルは APP_SETTINGS_FILE でも指定可能（相対なら APP_ROOT 基準）
# ============================================================
...
class PathConfig:
    ...
    def ensure_dirs(self):
        ...
        for p in (self.data_root, self.vs_root, self.backup_root):
            try:
...
# === PathConfig ===
#  preset      : Develop
#  app_root    : /Users/you/your_app
#  ssd_path    : /Users/you/your_app
#  pdf_root    : /Users/you/your_app/pdf
#  backup_root : /Users/you/your_app/backup
#  data_root   : /Users/you/your_app/data
#  vs_root     : /Users/you/your_app/data/vectorstore
...
#  pdf_root    : /Users/macmini2025/myVenv/myProject/internal_bot_shards_app/develop/pdf
#  backup_root : /Users/macmini2025/myVenv/myProject/internal_bot_shards_app/develop/backup
#  data_root   : /Users/macmini2025/myVenv/myProject/internal_bot_shards_app/develop/data
#  vs_root     : /Users/macmini2025/myVenv/myProject/internal_bot_shards_app/develop/data/vectorstore
