...
if go and st.session_state.q.strip():
    ...
    # ★ SQLite にも vectorspace を残す（スキーマ変更なしで確実に判別できるよう page に埋め込む）
    page_for_sqlite = f"{_PAGE_NAME}__{vectorspace}"  # 例: "13_ボット（ログ管理拡張版）__openai"
